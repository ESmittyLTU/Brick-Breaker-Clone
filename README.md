...
* **Project**   - Brick Breaker Clone (Midterm Project)
* **Your Name** - Eli Smith
* **Date**      - 10/30/2024
...
Use the mouse to control the paddle. Use the paddle to hit the ball (as fast as you can handle) into the bricks. Clear all the bricks to win!
